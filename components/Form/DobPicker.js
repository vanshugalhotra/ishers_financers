  ...
  return (
    <div className="relative">
      <DatePicker
        ...
        className="block w-full px-3 py-2 text-base placeholder-gray-400 border border-gray-300 rounded-md shadow-sm appearance-none focus:outline-none focus:ring-1 focus:ring-orange-500 focus:border-orange-500"
      />
